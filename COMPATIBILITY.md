...
| Keep-alive | **Measured, diverges** | Was absent. Now sent, but checked on a 29s ticker rather than on every timeout pass (`:1271-1274`), so it leaves 29 to 58 seconds after the last packet where libutp's leaves after 29. Measured 58.21s against 29.70s. Not yet fixed; KNOWN-LIMITATIONS.md, section 2e |
